            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.reservations.inputs.salle_id')
                            </th>
                            <th class="text-left">
                                @lang('crud.reservations.inputs.classe_id')
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                {{ optional($reservation->salle)->nom ?? '-' }}
                            </td>
                            <td>
                                {{ optional($reservation->classe)->nom ?? '-' }}
                            </td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3">{!! $reservations->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
